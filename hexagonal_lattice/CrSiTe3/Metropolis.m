...
%{
for ii = 1:L^2
rnd_theta = unifrnd(0,1,1,1)*pi;
%rnd_phi = unifrnd(0,1,1,1)*2*pi;

delta_E = nearest_energy(ii,rnd_theta,res_phi(ii),res_theta,res_phi)- ... 
    nearest_energy(ii,res_theta(ii),res_phi(ii),res_theta,res_phi);
...
delta_E = nearest_energy(ii,res_theta(ii),rnd_phi,res_theta,res_phi)- ... 
    nearest_energy(ii,res_theta(ii),res_phi(ii),res_theta,res_phi);
